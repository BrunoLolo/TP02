...
public class PersonaController {
	...
	public ModelAndView guardarPersona(@ModelAttribute("persona") Persona personaGuardar) {
		...
		personaGuardar.setEdad(calcularEdad(personaGuardar.getFechaNaci()));
		personaGuardar.setSignoZodiaco(determinarZodiaco(personaGuardar.getFechaNaci()));
		personaGuardar.setEstacion(determinarEstacion(personaGuardar.getFechaNaci()));
	...
	private String determinarZodiaco(LocalDate fNacimiento) {
		int dias = fNacimiento.getDayOfMonth();
